...
var MovieInfo = /** @class */ (function () {
    ...
    MovieInfo.prototype.메서드 = function (msg) {
        //msg 응원메시지 전달 변수
        return "\uC601\uD654 ".concat(this.제목, "\uC758 \uAC10\uB3C5\uB2D8 \uC774\uB984\uC740 ").concat(this.감독, "\uC785\uB2C8\uB2E4,\n        \uB098\uC758 \uC751\uC6D0\uC740 ").concat(msg);
    };
    return MovieInfo;
}()); /* ######### clss########## */
...
// html 변수
var hcode = "";
for (var _i = 0, mi_1 = mi; _i < mi_1.length; _i++) {
    var x = mi_1[_i];
    hcode += "<ul>";
    hcode += "\n                    <li><h2>\uC81C\uBAA9: ".concat(x.제목, "</h2></li>\n                    <li><img src=\"").concat(x.포스터, "\" alt=\"").concat(x.제목, "\uD3EC\uC2A4\uD130\"></li>\n                ");
    hcode += "</ul>";
    //메서드 찍어보기                
