...
/****************************************************************
    [ Props 사용하기 ]
    props 는 properties에서 나온 말로
    속성들... 즉, 변수에 값을 할당하여 전달하는 방법
    함수의 전달값과 같고 속성으로 컴포넌트에 보낸다
    -> props 는 05번에서 자세히 다룰예정
****************************************************************/
// 내가 좋아하는 색 표시하기 컴포넌트
function Favorite(props) { //props는 속성세팅 변수 집합
    return (
        <h2>내가 좋아하는 색은 {props.color}이야<br /> 그리고 좋아하는 음식은 {props.food}이다. <br /> 취미는 {props.hobby}이야. 알겠니?</h2>
    );
}////////////////////////////// Favorite 컴포넌트
...
// 여기서는{props.color} 형식으로 사용함

// 컴포넌트 재사용하기
ReactDOM.render(<Favorite color="파란색" food="치킨" hobby="운동" />, document.querySelector("#root4"));
