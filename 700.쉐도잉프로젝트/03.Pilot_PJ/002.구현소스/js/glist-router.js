...
let Glist = {
    ...
    <section>
        ...
        <div class="grid">
            <div 
            v-for="(v, i) in $store.state.gdata" v-if="v.cat==$store.state.selnm[0] || v.cat==$store.state.selnm[1] || v.cat ==$store.state.selnm[2] " @click="$store.commit('setBtn')">
            ...
            <div class="inx">
                ...
                <section class="gdesc scbar">
                    ...
                    <div>
                        ...
                        <button class="btn scbtn" @click.prevent="$store.commit('setData', ($route.params.id-1))">SHOPPING CART</button>
                        <button class="btn" @click.prevent = "$store.commit('clearData')">CLEAR CART</button>
