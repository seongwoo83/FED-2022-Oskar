...
/*****************************************
    ...
    8. 마지막 위치 (lx)초기값 설정후 화면크기변경시 이 값이 업데이트 되지 않아서 드래그 슬라이드가 오작동 되므로 goDrag() 함수내에 window의 resize이벤트 함수를 등록하여 lx값이 슬라이드크기에 상대적인 위치로 변경된 값을 업데이트 하도록 하여 오작동을 막아준다!
*****************************************/
function goDrag(obj) {
    /* 변수만들기 */
    /* 1. 드래그 상태변수 */
